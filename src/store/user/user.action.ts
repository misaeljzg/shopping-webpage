...
export type EmaiSignInStart = ActionWithPayload<USER_ACTION_TYPES.EMAIL_SIGN_IN_START, {email: string, password: string}>;
...
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, {user: User, additionalDetails: ExtraInfo}>
...
export const emailSignInStart = withMatcher((email: string, password:string ): EmaiSignInStart =>
...
export const signUpSuccess = withMatcher((user: User, additionalDetails: ExtraInfo): SignUpSuccess => 
  createAction(USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user, additionalDetails }));

export const signUpFailed = withMatcher((error: Error): SignUpFailed => createAction(
  USER_ACTION_TYPES.SIGN_UP_FAILED, error
));
